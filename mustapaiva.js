...
var copyrightCampaign = function(options) {
    ...
    if (typeof jQuery === "undefined") {
        ...
        script_tag.onload = main; // Run main() once jQuery has loadedh1
